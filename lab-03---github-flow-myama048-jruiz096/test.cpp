...
TEST(EchoTest, OneLetterMissing){
	char* test_val[4]; test_val[0] = "./c-echo-count"; test_val[1] = "hello"; test_val[2] = "world"; test_val[3] = "!";
	EXPECT_NE("hello world", echo(4, test_val));
}

//TEST2
TEST(EchoTest, GoodbyeWorld){
	char* test_val[3]; test_val[0] = "./c-echo-count"; test_val[1] = "goodbye"; test_val[2] = "world";
	EXPECT_NE("hello world", echo(3, test_val));
}

//TEST3
TEST(EchoTest, NUMS_WRONG_ORDER){
	char* test_val[2]; test_val[1] = "./c-echo-count"; test_val[0] = "333";
